...
using UserCredentials = HeznekLaatid.Core.View_Model.UserAuthenticationViewModel;
using UserRegisterData = HeznekLaatid.Core.View_Model.UserRegistrationViewModel;

namespace HeznekLaatid.Services.Authorization.Controllers
{
    public class TokenController : ApiController
    {
        private readonly ITokenUserRepository userRepository;

        public TokenController(ITokenUserRepository userRepository)
        {
